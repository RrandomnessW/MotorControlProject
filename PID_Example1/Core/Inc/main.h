...
#define Homing1_Pin GPIO_PIN_6
#define Homing1_GPIO_Port GPIOA
#define Homing2_Pin GPIO_PIN_7
#define Homing2_GPIO_Port GPIOA
...
#define IN1_A_Pin GPIO_PIN_4
#define IN1_A_GPIO_Port GPIOB
#define IN1_B_Pin GPIO_PIN_5
#define IN1_B_GPIO_Port GPIOB
#define IN2_A_Pin GPIO_PIN_6
#define IN2_A_GPIO_Port GPIOB
#define IN2_B_Pin GPIO_PIN_7
